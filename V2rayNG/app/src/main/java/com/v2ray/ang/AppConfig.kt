...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/private-gojo/RelayX"
    const val APP_API_URL = "https://api.github.com/repos/private-gojo/RelayX/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/private-gojo/RelayX/master/CR.md"
